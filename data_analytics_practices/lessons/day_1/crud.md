...
to read the data from csv you must declare the path first of the file
...
# Update
for saving a csv you must you can use the same csv file or create a new file by declaring it to the path
for example
